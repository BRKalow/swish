...
class SnippetsControllerTest < ActionController::TestCase
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post :create, snippet: { body: @snippet.body, language: @snippet.language, num_comments: @snippet.num_comments, num_favorites: @snippet.num_favorites, num_views: @snippet.num_views, title: @snippet.title }
    end
  ...
  test "should update snippet" do
    patch :update, id: @snippet, snippet: { body: @snippet.body, language: @snippet.language, num_comments: @snippet.num_comments, num_favorites: @snippet.num_favorites, num_views: @snippet.num_views, title: @snippet.title }
    assert_redirected_to snippet_path(assigns(:snippet))
  end
